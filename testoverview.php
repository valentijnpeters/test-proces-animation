...
<head>
    ...
    <script>
        (() => {
            const measurementId = 'G-NQ7JFWBNXP';
            window.dataLayer = window.dataLayer || [];
            window.gtag = window.gtag || function () {
                window.dataLayer.push(arguments);
            };
            window.testOverviewGa4MeasurementId = measurementId;
            window.testOverviewGa4Enabled = /^(www\.)?testenvansoftware\.nl$/i.test(window.location.hostname);
            if (!window.testOverviewGa4Enabled) {
                return;
            }
...
A decision table combines these three outcomes into the eight possible states shown here. In this way, one technique produces information that another technique can use, revealing test scenarios that would be easy to miss if every technique were applied separately.`
        ...
        async function playDashboardCommandCentreIntro(dashboardWindow) {
                        ...
                        <div class="guide-window-body">
                            ...
                            <section class="guide-section">
                                ...
                                <div class="guide-link-grid">
                                    <a class="guide-link-card" href="https://www.linkedin.com/in/ing-valentijn-p-b696371/" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <a class="guide-link-card" href="https://breaksoftwaretesting.com" target="_blank" rel="noopener noreferrer">
